...
CREATE TABLE IF NOT EXISTS tf.Pacientes (
	...
	id_email INT REFERENCES tf.Email(id_email) ON DELETE SET NULL,
	id_telefone INT REFERENCES tf.Telefones(id_telefone) ON DELETE SET NULL,
...
INSERT INTO tf.Telefones (numero, tipo, principal) VALUES
('11987654321', 'Celular', TRUE),
('1134567890', 'Residencial', TRUE),
('21987654322', 'Celular', TRUE),
('31987654323', 'Celular', TRUE),
('41987654324', 'Fixo', TRUE),
('51987654325', 'Celular', TRUE),
('61987654326', 'Residencial', TRUE),
('71987654327', 'Fixo', TRUE),
('81987654328', 'Celular', TRUE),
('91987654329', 'Fixo', TRUE);

INSERT INTO tf.Email (email, principal) VALUES
('ana@gmail.com',TRUE),
('carlos@hotmail.com', TRUE),
('mariana@yahoo.com', TRUE),
('joao@empresa.com', TRUE),
('fernanda@outlook.com', TRUE),
('ricardo@gmail.com', TRUE),
('paula@trabalho.com', TRUE),
('andre@gmail.com', TRUE),
('beatriz@outlook.com', TRUE),
('eduardo@empresa.com', TRUE);

INSERT INTO tf.Pacientes (nome, cpf, id_email, id_telefone, data_nascimento, id_endereco) VALUES
('Ana Souza', '111.222.333-44', 1, 1, '1985-06-15', 1),
('Carlos Lima', '222.333.444-55', 2, 2, '1990-09-25', 2),
('Mariana Castro', '333.444.555-66', 3, 3, '1982-04-10', 3),
('João Pereira', '444.555.666-77', 4, 4, '1995-12-01', 4),
('Fernanda Silva', '555.666.777-88', 5, 5, '1988-07-07', 5),
('Ricardo Alves', '666.777.888-99', 6, 6, '1975-11-20', 6),
('Paula Ramos', '777.888.999-00', 7, 7, '1998-03-14', 7),
('André Vasconcelos', '888.999.000-11', 8, 8, '1983-05-29', 8),
('Beatriz Oliveira', '999.000.111-22', 9, 9, '1991-01-17', 9),
('Eduardo Mendes', '000.111.222-33', 10, 10, '1980-08-09', 10);

INSERT INTO tf.Dentistas (nome, cpf, cro, especialidade, id_email, id_telefone, id_endereco) VALUES
('Dr. Pedro Rocha', '111.111.111-11', 'SP12345','Ortodontia', 1, 1, 1),
('Dra. Juliana Mendes', '222.222.222-22', 'RJ23456','Periodontia', 2, 2, 2),
('Dr. Fernando Costa', '333.333.333-33', 'MG34567','Endodontia', 3, 3, 3),
('Dra. Ana Beatriz', '444.444.444-44', 'PR45678','Implantodontia', 4, 4, 4),
('Dr. Marcelo Lima', '555.555.555-55', 'RS56789', 'Pediatria', 5, 5, 5),
('Dra. Patrícia Souza', '666.666.666-66', 'BA67890','Estética', 6, 6, 6),
('Dr. Rafael Nogueira', '777.777.777-77', 'CE78901','Cirurgia', 7, 7, 7),
('Dra. Vanessa Torres', '888.888.888-88', 'DF89012', 'Protesista', 8, 8, 8),
('Dr. Lucas Barros', '999.999.999-99', 'AM90123', 'Odontopediatria', 9, 9, 9),
('Dra. Camila Ferreira', '000.000.000-00', 'PE01234', 'Odontologia do Trabalho', 10, 10, 10);
